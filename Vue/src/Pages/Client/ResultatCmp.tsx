...
import Results from "../../Components/Pages/Client/ResultatComparison/Results";
...
function ResultatCmp() {
  ...
  return (
        <div className="bg-[#F0EFF2] flex flex-col justify-center items-center pt-[5vh]">
            <ScrollRestoration />
                {
                    !(bankFirst && bankSecond) && <div className="h-screen w-full flex flex-col justify-center items-center gap-[10vh]">
                ...
                <div className="flex px-[9vw] items-center py-[10vh]">
                    {(bankFirst && bankSecond) &&
                    
                    <div className="flex flex-col w-[50vw] py-[5vh] items-center justify-center">
                        <div className="flex justify-center items-center md:max-h-[10vw] gap-[5vw] max-h-[5vh]">
                            <div className="lg:w-[30vw] md:w-[40vw] md:h-[15vh] h-[10vh] w-[40vw] items-center flex justify-center bg-white overflow-hidden">
                                <img className="md:max-w-[20vw] w-[70vw]" src={bankFirst.logo} alt={"props.imageUrl"} />
                            </div>
                            <div className="lg:w-[30vw] md:w-[40vw] md:h-[15vh] h-[10vh] w-[40vw] items-center flex justify-center bg-white overflow-hidden">
                                <img className="md:max-w-[20vw] w-[70vw]" src={bankSecond.logo} alt={"props.imageUrl"} />
                            </div>    
                        </div>
                        
                        <div className="flex flex-col md:gap-[2vh] gap-[4vh] w-[40vw] px-[4vw] py-[10vh] items-center justify-center text-center lg:text-[1.2rem] md:text-[0.9rem] text-[0.8rem]">
                            <div className="flex justify-center items-center max-h-[10vw] gap-[5vw]">
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankFirst.nom_banque}</h3></div>
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankSecond.nom_banque}</h3></div>
                            </div> 
                            <div className="flex justify-center items-center max-h-[10vw] gap-[5vw]">
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankFirst.adresse}</h3></div>
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankSecond.adresse}</h3></div>
                            </div>
                            <div className="flex justify-center items-center max-h-[10vw] gap-[5vw]">
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankFirst.num_tel}</h3></div>
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankSecond.num_tel}</h3></div>
                            </div>
                            <div className="flex justify-center items-center max-h-[10vw] gap-[5vw]">
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankFirst.num_fax}</h3></div>
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankSecond.num_fax}</h3></div>
                            </div>   
                            <div className="flex justify-center items-center max-h-[10vw] gap-[5vw]">
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankFirst.adresse_mail}</h3></div>
                                <div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankSecond.adresse_mail}</h3></div>
                            </div>   
                            <div className="flex justify-center items-center max-h-[10vw] gap-[5vw]">
                                <Link to={bankFirst.site_web}><div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankFirst.site_web}</h3></div></Link>
                                <Link to={bankSecond.site_web}><div className="flex justify-center items-center bg-white rounded-[4px] h-[5vw] py-[4vh] px-[1vw] font-light lg:w-[30vw] md:w-[40vw] md:max-h-[15vh] h-[10vh] w-[40vw]"><h3>{bankSecond.site_web}</h3></div></Link>
                            </div>   
                        </div>
                    </div>
                    }
                ...
                {offreFirst && offreSecond && 
                    <div className="mb-[30vh]">
                        <table className="w-[82vw]">
                            <thead>
                                <tr>
                                    <th className="px-16 py-3 text-center lg:text-[1.8rem] md:text-[1.4rem] text-[1.2rem] bg-BlueDark font-light text-white tracking-wider border-b-2 pt-8 pb-8">
                        ...
                        <tbody className="bg-white w-[100%]">  
                            <tr>
                              <td className="py-8">
                                    <div className="lg:text-[1.4rem] md:text-[1.2rem] font-medium text-center text-BlueDark">
